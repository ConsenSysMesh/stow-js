...
- `linniaTokenContractAddress`:`String` - Address of the LinniaToken.  The ropesten testnet address is `0x4cdfbdec0aa003116bf030f249a8a7285cd6a184`
### Example
...
Add record to Linnia and receive a small reward of linnia tokens.  This requies an optional parameter
